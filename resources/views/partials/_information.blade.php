    ...
    <div class="sticky top-24">
        ...
        @if($squareBanner->isNotEmpty())
            <div data-aos-delay="200" data-aos="fade-down" data-aos-easing="ease-in-out" class="mt-8">
                ...
                <!-- 1. TAMBAHKAN DIV PEMBUNGKUS UNTUK MENGONTROL UKURAN -->
                <div class="w-5/6 mx-auto">
                    <!-- Alpine.js Slider Component -->
                    <div x-data="{
                            currentIndex: 0,
                            images: {{ $squareBanner->pluck('banner')->map(fn($url) => Storage::url($url))->toJson() }},
                            autoplay() {
                                setInterval(() => {
        ...
        @if($rectangularBanner->isNotEmpty())
            <!-- 2. TAMBAHKAN DIV PEMBUNGKUS DI SINI JUGA -->
            <div class="w-5/6 mx-auto">
                <div x-data="{
                        currentIndex: 0,
                        images: {{ $rectangularBanner->pluck('banner')->map(fn($url) => Storage::url($url))->toJson() }},
                        autoplay() {
                            setInterval(() => {
                                this.currentIndex = (this.currentIndex + 1) % this.images.length;
                            }, 5000);
