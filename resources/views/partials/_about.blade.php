<div id="about" class="bg-blue-900 text-white w-full">
    <p class="text-center text-sm">
        ...
        <span class="text-white justify-center flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60"><path fill="currentColor" d="m12 15l-10-10h20z"/></svg>
        </span>
    </p>
    
    <div class="fade-up mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
